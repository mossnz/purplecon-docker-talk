...
- **container-diff**, a Google open source tooling
- **inspec**, a Compliance as Code tooling
---
### https://github.com/GoogleContainerTools/container-diff
### $ container-diff diff redis.tar remote://mossnz/purple-redis:production 
### --type=file
~~~
