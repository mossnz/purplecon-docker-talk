...
~~~notes
When I was submitting this talk, I pulled a container name out of thin air. Redis, I said.
Since a lot of people put redis in a container. It's the fourth most popular image on Docker Hub.
