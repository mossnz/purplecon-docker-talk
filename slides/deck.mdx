...
~~~
---
## The moral of the story is you can't trust code you didn't build yourself.

~~~notes
And public docker containers are definitely code we didn't build ourselves.

But what if we _could_ build them? Without having to stop our minimally viable product and draw the entire owl.
~~~
---